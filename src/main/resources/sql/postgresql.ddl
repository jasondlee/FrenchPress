...
CREATE TABLE IF NOT EXISTS comments (ID BIGINT NOT NULL, version BIGINT NOT NULL, AUTHOREMAIL VARCHAR(255), AUTHORNAME VARCHAR(255), AUTHORURL VARCHAR(255), BODY VARCHAR(255), AUTHOR_ID BIGINT, PRIMARY KEY (ID))
