...
CREATE TABLE IF NOT EXISTS mediaitems (ID BIGINT NOT NULL, version BIGINT NOT NULL, NAME VARCHAR(255), FILESIZE BIGINT NOT NULL, MIMETYPE VARCHAR(255), CONTENTS LONGBLOB, PRIMARY KEY (ID));
